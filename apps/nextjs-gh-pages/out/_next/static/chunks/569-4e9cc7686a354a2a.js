  ...
  [569],
  {
    ...
    3646: function (e, t, o) {
      ...
      let b = r.default.forwardRef(function (e, t) {
        ...
        let L = !1 !== g,
          w = r.default.useContext(c.RouterContext),
          S = r.default.useContext(i.AppRouterContext),
          I = null != w ? w : S,
          R = !w,
          { href: T, as: D } = r.default.useMemo(() => {
            if (!w) {
              let e = y(a)
              return { href: e, as: h ? y(h) : e }
            }
            let [t, o] = u.resolveHref(w, a, !0)
            return { href: t, as: h ? u.resolveHref(w, h) : o || t }
          }, [w, a, h]),
          K = r.default.useRef(T),
          N = r.default.useRef(D)
        P && (n = r.default.Children.only(o))
        let U = P ? n && 'object' == typeof n && n.ref : t,
          [B, H, A] = s.useIntersection({ rootMargin: '200px' }),
          Z = r.default.useCallback(
            (e) => {
              ;(N.current !== D || K.current !== T) &&
                (A(), (N.current = D), (K.current = T)),
                B(e),
                U &&
                  ('function' == typeof U
                    ? U(e)
        ...
        r.default.useEffect(() => {
          I && H && L && v(I, T, D, { locale: j })
        }, [D, T, H, j, L, null == w ? void 0 : w.locale, I])
        let q = {
          ref: Z,
          onClick(e) {
        ...
        if (!P || _ || ('a' === n.type && !('href' in n.props))) {
          let z = void 0 !== j ? j : null == w ? void 0 : w.locale,
            F =
          ...
          q.href =
            F ||
            p.addBasePath(
              f.addLocale(D, z, null == w ? void 0 : w.defaultLocale),
            )
        }
        return P
          ? r.default.cloneElement(n, q)
          : r.default.createElement('a', Object.assign({}, x, q), o)
      })
      ;(t.default = b),
        ('function' == typeof t.default ||
          ('object' == typeof t.default && null !== t.default)) &&
        ...
        (t.useIntersection = function (e) {
          ...
          n.useEffect(() => {
            if (r) {
              if (!c && !i && d && d.tagName) {
                let e = (function (e, t, o) {
                  ...
                  return (
                    ...
                    l.observe(e),
                    function () {
                      if ((r.delete(e), l.unobserve(e), 0 === r.size)) {
                        l.disconnect(), u.delete(n)
                        let t = a.findIndex(
              ...
              let n = l.requestIdleCallback(() => s(!0))
              return () => l.cancelIdleCallback(n)
            }
          }, [d, c, o, t, i])
          let h = n.useCallback(() => {
            s(!1)
